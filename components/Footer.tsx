...
const iconClass = "inline-block w-[13px] h-[13px] align-[-1px] stroke-current";
...
export default function Footer() {
  return (
    <p className="text-base mb-5 text-[#444]">
      ...
      >
        {/* X (Twitter) icon */}
        <svg className={iconClass} style={{ strokeWidth: "0.4px" }} viewBox="0 0 24 24" fill="currentColor">
