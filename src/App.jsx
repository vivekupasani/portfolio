...
import photo from "./assets/photowithoutbg.png";
import {
  Github,
  ExternalLink,
  Mail,
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-12">
          <div className="md:mr-8">
            ...
            <p className="text-gray-700 mb-6">
              For quick connect just drop me a Hey! on X, I'm pretty active
              there.
            </p>
        ...
        <div className="md:py-8">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-1">
              ...
              <p className="text-gray-500">Dec 2024 - Apr-2025</p>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-1">
              ...
              <p className="text-gray-500">May 2024 - Jan 2025</p>
            </div>
          </div>
        </div>
        ...
        <div className="py-8">
          ...
          <p className="text-gray-600 mb-8">
            I'm currently working on an AI-powered code review SaaS tool
            designed to help developers write better code. I'm passionate about
            building products that enhance productivity and simplify the
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                real-time. Firebase powers authentication and media storage,
                while clean architecture ensures smooth, scalable performance.
              </p>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                It offers high-performance mock APIs for developers, testers,
                and businesses. It provides fast responses and realistic data,
                perfect for learning API integration, testing, or
                prototyping—without the need for a backend.
              </p>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                to upload, manage, and store media files securely. With
                Cloudinary integration for media storage, CloudStash ensures
                smooth, high-performance file management.
              </p>
