...
export const projects: Project[] = [
    {
        ...
        description: [
            "built a desktop voice transcription app that records with a simple push-to-talk flow — hold a key, speak, and release to transcribe instantly. powered fast speech-to-text with Groq's Whisper Large V3. added an optional AI refinement step that cleans up grammar and removes filler words. included customizable hotkeys, from Option, Command, and Control to the F1-F12 keys. made it auto-paste the text into any active app while running quietly in the system tray.",
        ],
    ...
    },
    {
        ...
        description: [
            "built an open-world style car driving game with realistic physics and responsive controls. created a free-roam driving experience across highways, city roads, and off-road environments. added features like drifting, nitro boost, collision mechanics, and dynamic camera modes. built it with React Three Fiber and Rapier physics for smooth high-performance gameplay right in the browser. added immersive visuals with lighting effects, moving traffic props, and detailed environments.",
        ],
    ...
    },
    {
        ...
        description: [
            "built a full-fledged e-commerce jewelry store where users can browse a wide collection of pieces with high-quality images, detailed descriptions, and pricing. added a shopping cart so users can add products, update quantities, and manage selected items before purchase. implemented a smooth and secure checkout process with full payment integration. included order management so users can track their orders, view order history, and manage their purchases easily.",
        ],
    ...
    },
    {
        ...
        description: [
            "built a cross-platform medication reminder app that works seamlessly on both iOS and Android. set up medication scheduling with fully custom reminders for timely doses. added refill tracking so users can monitor their medicine supply and get alerts when it's low. secured access with biometric authentication using Face ID or Touch ID. included progress tracking to log daily medication intake with a full history. added calendar integration to manage doses efficiently. stored all data safely on-device using AsyncStorage.",
        ],
    ...
    },
    {
        ...
        description: [
            "built a real-time chat application with complete sign-up and login functionality. added profile setup so users can create and update their name, profile picture, and about info. implemented friend requests to send, receive, and accept connections. built instant text messaging between users. added image sharing, including sending and receiving photos in chat. included status updates users can upload and view. supported both light and dark themes for a consistent user experience.",
        ],
    ...
    },
    {
        ...
        description: [
            "built a complete social media platform with fully real-time features. implemented image sharing, likes, and comments. developed a real-time chat system using Firebase Firestore. focused on creating a smooth and engaging user experience.",
        ],
